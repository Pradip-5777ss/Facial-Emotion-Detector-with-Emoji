...
emotion_dict = {0: "Angry", 1: "Disgusting", 2: "fear",
                3: "happy", 4: "neutral", 5: "sad", 6: "surprised"}
curr_path = os.path.dirname(os.path.abspath(__file__))

emoji_dist = {0: curr_path+"/emojis/angry.png",
              1: curr_path+"/emojis/disgusting.png",
              2: curr_path+"/emojis/fear.png",
              3: curr_path+"/emojis/happy.png",
              4: curr_path+"/emojis/neutral.png",
              5: curr_path+"/emojis/sad.png",
              6: curr_path+"/emojis/surprised.png"}
